...
namespace SCRL.Systems
{
  class Path
  {
    private readonly LinkedList<ITile> _steps;
    private LinkedListNode<ITile> _currentStep;
    ...
    public Path(IEnumerable<ITile> steps)
    {
      _steps = new LinkedList<ITile>(steps);
    ...
    /// </summary>
    public IEnumerable<ITile> Steps
    {
      get {
        return _steps;
      }
    ...
    public ITile StepForward()
    {
      ITile cell = TryStepForward();
    ...
    public ITile TryStepForward()
    {
      LinkedListNode<ITile> nextStep = _currentStep.Next;
      if (nextStep == null)
      {
        return null;
      }
    ...
    public ITile StepBackward()
    {
      ITile cell = TryStepBackward();
    ...
    public ITile TryStepBackward()
    {
      LinkedListNode<ITile> previousStep = _currentStep.Previous;
